...
const NAMESPACE = 'easycredit-components';
        ...
        if (Cstr.style) {
            ...
            if (!styles.has(scopeId)) {
                ...
                if (cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                    style = await Promise.resolve().then(function () { return require('./shadow-css-291657d1.js'); }).then((m) => m.scopeCss(style, scopeId, false));
                }
